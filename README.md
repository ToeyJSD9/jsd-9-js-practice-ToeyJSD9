...
3. step 3
ตอนนี้ที่เป็นกังวล คือเรื่องของlogic อย่างเช่น if else !![alt text](image-1.png) เต้ยก็ได้กลับไปทำความเข้าใจใหม่ ทั้งคืน เพื่อจะได้เขียน Handle movement รู้เรื่อง และก็เรื่องของลูปด้วย
4.  step n
